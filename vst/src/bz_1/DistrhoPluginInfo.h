...
#define DISTRHO_PLUGIN_NAME    "BZ-1"
#define DISTRHO_PLUGIN_URI     "urn:rigbuilder:bz1"
#define DISTRHO_PLUGIN_CLAP_ID "rigbuilder.bz1"

#define DISTRHO_PLUGIN_BRAND_ID  Rgbd
#define DISTRHO_PLUGIN_UNIQUE_ID Bz01
