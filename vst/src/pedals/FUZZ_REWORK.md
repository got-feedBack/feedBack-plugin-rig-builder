...
|---|---|---|---|---|
| `Pedal_CaptFuzzle` | `Buzz-Tone.vst3` | 1.5 V Captain Fuzzle / Maestro FZ-1A style, 3x 2N1305 | `pedals/captain fuzzle.gif` | Reworked and calibrated to the new Attack min/noon/max renders; 4x oversampled |
...
| `Extra_FuzzRite` | `FuzzRite.vst3` | Mosrite Fuzz Rite style silicon fuzz | `pedals/fuzzrite/FuzzRiteV3.pdf` | Depth source/load network calibrated to the new min/noon/max renders; stable C4 feedback and full-DI dropout audit pass |
...
- ATTACK pot changes Q2 bias/feedback texture rather than acting as a generic
    linear gain.
