 ...
 * compact pedal it models: Chief-style enclosure, name strip, big treadle
 * footswitch and the real four CEB-3 controls. */
...
public:
    BassChorusUI() : PedalKitUI(300, 480, kParamCount, kBassChorusDef) {
        ...
        addKnob(kLowFilter, 0.595f, 0.235f, 0.072f, 24,24,26, 1);
        addKnob(kELevel,    0.790f, 0.235f, 0.072f, 24,24,26, 1);
    }
protected:
    void drawFace() override {
        ...
        textSpaced(0.790f,0.135f,8.0f,w,"E.LEVEL",fBarlow, 0.2f);
