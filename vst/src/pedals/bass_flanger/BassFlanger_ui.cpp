/* FL-3 UI - copyright-free bass flanger panel with the real BF-2B controls. */
...
public:
    BassFlangerUI() : PedalKitUI(300, 480, kParamCount, kBassFlangerDef) {
        ...
        addKnob(kManual, 0.205f, 0.235f, 0.072f, 26,24,30, 1);
        addKnob(kDepth,  0.400f, 0.235f, 0.072f, 26,24,30, 1);
        addKnob(kRate,   0.595f, 0.235f, 0.072f, 26,24,30, 1);
        addKnob(kRes,    0.790f, 0.235f, 0.072f, 26,24,30, 1);
    }
protected:
    void drawFace() override {
        chiefPedal(96, 80, 134);                  // muted purple body
        const Color w(236,232,242);
        textSpaced(0.205f,0.135f,8.0f,w,"MANUAL",fBarlow, 0.2f);
        textSpaced(0.400f,0.135f,8.5f,w,"DEPTH",fBarlow, 0.2f);
        textSpaced(0.595f,0.135f,8.5f,w,"RATE",fBarlow, 0.2f);
        textSpaced(0.790f,0.135f,8.5f,w,"RES",fBarlow, 0.2f);
