...
static const char* const kGa88Names[kParamCount]   = { "Volume", "Bass", "Treble", "Cab Sim" };
static const char* const kGa88Symbols[kParamCount] = { "volume", "bass", "treble", "cabsim" };
static const float kGa88Min[kParamCount] = { 0,0,0,0 };
static const float kGa88Max[kParamCount] = { 1,1,1,1 };
static const float kGa88Def[kParamCount] = { 0.60f, 0.50f, 0.50f, 1.00f };
