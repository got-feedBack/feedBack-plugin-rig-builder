...
class Ad50Plugin : public Plugin {
    ...
    void applyAll(){ core.setGain(fP[kGain]); core.setBass(fP[kBass]); core.setMiddle(0.5f);
...
public:
    Ad50Plugin() : Plugin(kParamCount,0,0){ for(int i=0;i<kParamCount;++i)fP[i]=kAd50Def[i];
        core.configure(250e3,470e3,25e3,33e3,250e-12,22e-9,22e-9, 0.35f,6.5f,13.0f,3000.0f,3.0f);
