/*
 * Aiden GT-550 — Eden WT-550 "The Traveler 550" (Valve-Tech hybrid bass head).
 *
 ...
 * Schematic: Eden WT-550 preamp ("WT404", 2004) — the SAME preamp as the WT-300,
 * driving a bigger ~550 W power section (the model enum sets the deeper low-end).
 *
...
public:
    EdenPlugin() : Plugin(kParamCount, 0, 0) {
        ...
        core.setModel(eden::EdenCore::WT550);
...
protected:
    ...
    const char* getDescription() const override { return "Eden WT-550 Valve-Tech bass head — circuit-real model"; }
