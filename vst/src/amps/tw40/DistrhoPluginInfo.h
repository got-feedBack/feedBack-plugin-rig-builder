...
#define DISTRHO_PLUGIN_NAME    "TW40"
#define DISTRHO_PLUGIN_URI     "urn:rigbuilder:tw40"
#define DISTRHO_PLUGIN_CLAP_ID "rigbuilder.tw40"

#define DISTRHO_PLUGIN_BRAND_ID  Rgbd
#define DISTRHO_PLUGIN_UNIQUE_ID Tw40
